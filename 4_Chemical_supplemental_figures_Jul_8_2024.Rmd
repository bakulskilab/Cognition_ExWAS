...
Adapting from Lauren's previous code
...
scatter_partic_by_chem_LOD <- ggplot(chem_stats,
  ...
  geom_text_repel(aes(label = ifelse(n > 2000, # changed 2500 -> 2000 to label 3 more outlier points
...
# scatterplot
ggsave(filename = 'Output Cog ExWAS/Scatterplot of chem N and LOD Jul 8 2024.pdf',
       plot = scatter_partic_by_chem_LOD,
       width = 14,
       height = 9)

ggsave(filename = 'Output Cog ExWAS/Scatterplot of chem N and LOD Jul 8 2024.png',
       plot = scatter_partic_by_chem_LOD,
       width = 14,
       height = 9,
       dpi = 600)
